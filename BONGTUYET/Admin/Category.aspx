<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="BONGTUYET.Admin.Category" %>
                        ...
                        <asp:Repeater ID="rCategory" runat="server" OnItemCommand="rCategory_ItemCommand">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td> 
                                        <img width="40" src="<%# BONGTUYET.Utils.getImageUrl( Eval("CategoryImageUrl")) %>" alt="image" />
                                    </td>
                                    <td>
